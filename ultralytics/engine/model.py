...
class Model(nn.Module):
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        if Path(weights).suffix == ".pt":
            ...
            weights = checks.check_file(weights)  # exp in all cases, not redundant with above call
    ...
    def reset_callbacks(self) -> None:
        ...
        modifications, ensuring consistent behavior across different exp or experiments.
