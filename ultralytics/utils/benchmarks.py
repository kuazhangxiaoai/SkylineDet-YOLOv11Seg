...
class ProfileModels:
    ...
    Attributes:
        ...
        num_timed_runs (int): Number of timed exp for the profiling.
        num_warmup_runs (int): Number of warmup exp before profiling.
    ...
    def __init__(
        ...
        Args:
            ...
            num_timed_runs (int): Number of timed exp for the profiling.
            num_warmup_runs (int): Number of warmup exp before the actual profiling starts.
    ...
    def profile_tensorrt_model(self, engine_file: str, eps: float = 1e-3):
        ...
        # Compute number of exp as higher of min_time or num_timed_runs
    ...
    def profile_onnx_model(self, onnx_file: str, eps: float = 1e-3):
        """Profiles an ONNX model, measuring average inference time and standard deviation across multiple exp."""
