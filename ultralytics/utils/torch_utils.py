...
def strip_optimizer(f: Union[str, Path] = "yolov11n-sky-seg.pt", s: str = "", updates: dict = None) -> dict:
    """
    Strip optimizer from 'f' to finalize training, optionally save as 's'.

    Args:
        f (str): file path to model to strip the optimizer from. Default is 'yolov11n-sky-seg.pt'.
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            ...
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as yolov11n-sky-seg.pt.\n"
