...
model = YOLO("path/to/yolov11n-sky-seg.pt")  # Load a custom trained model
...
yolo track model=path/to/yolov11n-sky-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/yolov11n-sky-seg.pt tracker="bytetrack.yaml"
```
