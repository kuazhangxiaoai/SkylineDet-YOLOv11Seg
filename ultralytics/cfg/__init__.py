...
TASKS = {"detect", "segment", "skyseg","rsiseg", "classify", "pose", "obb"}
TASK2DATA = {
    "detect": "coco8.yaml",
    "segment": "coco8-seg.yaml",
    "skyseg": "skyfinder.yaml",
    "rsiseg":"Potsdam.yaml",
    "classify": "imagenet10",
...
TASK2MODEL = {
    ...
    "skyseg": "yolov11n-skyseg.pt",
    "rsiseg": "yolov11n-rsiseg.pt",
...
TASK2METRIC = {
    ...
    "skyseg": "metrics/mAP50-95(M)",
    "rsiseg": "metrics/mAP50-95(M)",
...
def get_save_dir(args, name=None):
    ...
    if getattr(args, "save_dir", None):
        ...
        project = args.project or (ROOT.parent / "tests/tmp/exp" if TESTS_RUNNING else RUNS_DIR) / args.task
...
def handle_yolo_solutions(args: List[str]) -> None:
    """
    Processes YOLO solutions arguments and exp the specified computer vision solutions pipeline.
    ...
    Notes:
        ...
        - Output videos are saved in 'exp/solution/{solution_name}' directory
    ...
    if s_n == "analytics":  # analytical graphs follow fixed shape for output i.e w=1920, h=1080
        w, h = 1920, 1080
    save_dir = increment_path(Path("exp") / "solutions" / "exp", exist_ok=False)
...
def handle_streamlit_inference():
    ...
    This function initializes and exp a Streamlit application designed for performing live object detection using
