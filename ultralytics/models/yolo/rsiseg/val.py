...
from ultralytics.utils import DEFAULT_CFG, yaml_load, SKYSEG_CFG, RSISEG_CFG

from ultralytics.models.yolo.detect import DetectionValidator
from ultralytics.utils import LOGGER, NUM_THREADS, ops
from ultralytics.utils.checks import check_requirements
from ultralytics.utils.metrics import (SegmentMetrics, box_iou, mask_iou, mask_mcr, SemanticMetrics,
                                       mask_precision, dice_score, mask_recall, mask_accuracy)
from ultralytics.utils.plotting import output_to_target, plot_images
from ultralytics.utils.torch_utils import de_parallel
from ultralytics.data import build_potsam_dataset, build_dataloader

class RSISegmentationValidator(DetectionValidator):
    """
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        self.process = None
        self.args.task = "rsiseg"
        self.metrics = SemanticMetrics(save_dir=self.save_dir, on_plot=self.on_plot)
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        return build_potsam_dataset(self.args, img_path, batch, self.data, mode=mode, rect=False, stride=gs)
...
def validate(cfg=DEFAULT_CFG):
    ...
    val_dataset = build_potsam_dataset(
        cfg,
        img_path,
        bs,
        data,
    ...
    validator = RSISegmentationValidator(val_dataloader, Path(cfg.name))
    validator(model=model)

if __name__ == '__main__':
    validate(cfg=RSISEG_CFG)