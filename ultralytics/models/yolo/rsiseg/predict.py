...
from ultralytics.utils import DEFAULT_CFG, ops, RSISEG_CFG


class RSISegmentationPredictor(DetectionPredictor):
    """
...
def predict(cfg=DEFAULT_CFG, use_python=False):
    ...
    if use_python:
        ...
        predictor = RSISegmentationPredictor(cfg=cfg, overrides=args)
        predictor(source=source, model=model)


if __name__ == '__main__':
    predict(cfg=RSISEG_CFG)
